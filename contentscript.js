...
;// ./src/content-script/content-blockers/cosmetic-filter.ts
var CosmeticFilter = (function () {
    function CosmeticFilter(adBlockSelectors) {
        this.adBlockSelectors = adBlockSelectors;
    }
    CosmeticFilter.prototype.start = function () {
        if (!this.adBlockSelectors) {
            return;
        }
        var cssContent = "".concat(this.adBlockSelectors.join(','), " { display: none !important; }");
...
var jsonPruneXhrResponseSources = [
    {
...
var trustedReplaceFetchResponseSources = [
    {
...
var settings_Settings = (settings_a = {},
    ...
    settings_a[SettingsKeys.Scriptlets] = __spreadArray(__spreadArray(__spreadArray([], __read(constantSources), false), __read(jsonPruneXhrResponseSources), false), __read(trustedReplaceFetchResponseSources), false),
    settings_a);
...
;// ./src/content-script/run-youtube-logic.ts


var runYoutubeLogic = function (adBlockSelectors, popupConfig) {
    var filters = [new CosmeticFilter(adBlockSelectors), new PopupCreator(popupConfig)];
...
(function () { return content_script_awaiter(void 0, void 0, void 0, function () {
    var isAdBlockingWorksOnPage, response, ads, adBlockingSelectors, popupConfig;
    return content_script_generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                isAdBlockingWorksOnPage = /youtube\.com/.test(location.href);
                if (!isAdBlockingWorksOnPage)
                    return [2];
            ...
            case 1:
                ...
                if (!response)
                    return [2];
                ads = response.ads, adBlockingSelectors = response.adBlockingSelectors, popupConfig = response.popupConfig;
                if (!ads)
                    return [2];
                new runYoutubeLogic(adBlockingSelectors, popupConfig);
                return [2];
        }
    });
}); })();
